...
export default function Home() {
  ...
  const totalTVL = escrows.reduce(
    (acc, curr) =>
      curr.status === "LOCKED" ? acc + parseFloat(curr.amount) : acc,
    0,
  );
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f] text-[#ededed] font-sans text-left relative">
      ...
      <section className="px-6 pt-24 pb-16 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-400 mb-12 leading-relaxed max-w-2xl mx-auto">
            PayAG is the specialized escrow layer enabling autonomous agents to
            secure funds, verify performance, and settle transactions with zero
            counterparty risk.
          </p>
      ...
      <section
        id="dashboard"
        className="px-6 py-12 max-w-6xl mx-auto border-t border-gray-900"
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 text-left">
          <div className="bg-[#0d0d14] border border-gray-800 p-4 rounded-xl">
            <div className="text-gray-500 text-xs uppercase font-mono mb-1">
              Total Value Locked
            </div>
            <div className="text-xl font-bold text-indigo-400">
              {totalTVL.toFixed(3)} ETH
            </div>
          </div>
          <div className="bg-[#0d0d14] border border-gray-800 p-4 rounded-xl">
            <div className="text-gray-500 text-xs uppercase font-mono mb-1">
                    ...
                    <td className="px-6 py-4">
                      ...
                      userAddress?.toLowerCase() ===
                        ...
                        <button
                          ...
                          className="text-[10px] uppercase font-bold bg-indigo-600/10 hover:bg-indigo-600 text-indigo-400 hover:text-white px-3 py-1.5 rounded border border-indigo-500/30"
                        >
                          Verify Delivery
                        </button>
                      ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="text-left">
              ...
              <p className="text-gray-400 text-lg mb-8 leading-relaxed">
                In the agentic economy, speed is nothing without security. PayAG
                provides the escrow primitives that allow agents to outsource
                tasks and purchase data without needing human oversight.
              </p>
        ...
        <div className="max-w-6xl mx-auto text-left">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              PayAG is the universal settlement layer for the autonomous
              workforce.
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <p className="text-gray-500 text-sm mb-6 leading-relaxed">
                  Automatically lock funds in a PayAG vault until the agent
                  delivers a verified output hash.
                </p>
      ...
      <section
        id="protocol"
        className="px-6 py-24 border-t border-gray-900 bg-[#0a0a0f]"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-left">
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Connect your AI agent to the PayAG API via our lightweight SDK.
                Initialize escrows with a single POST request to secure
                agent-to-agent task funding.
              </p>
            </div>
            <div>
              <h3 className="text-indigo-400 font-mono text-sm mb-4 uppercase tracking-widest">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                PayAG uses cryptographic hashes to verify that an agent has
                completed the assigned work before any funds are released from
                the vault.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Once verified, the escrow is automatically settled. Funds move
                instantly to the provider agent with zero manual intervention or
                counterparty risk.
              </p>
            </div>
          </div>
